...
t_oscore_c_1_1(void) {
...
#endif
  coap_bin_const_t nonce = { sizeof(nonce_buffer), nonce_buffer };
  ...
  oscore_generate_nonce(cose, ctx->p_osc_ctx, nonce_buffer, sizeof(nonce_buffer));
...
t_oscore_c_2_1(void) {
  ...
  uint8_t nonce_buffer[13];
#endif
  coap_bin_const_t nonce = { 16, nonce_buffer };
...
t_oscore_c_4(void) {
  ...
  static const uint8_t protected_coap_request[] = {
    ...
    0x39, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x68, 0x6f,
    0x73, 0x74, 0x62, 0x09, 0x14, 0xff, 0x83, 0x03,
    0x06, 0xd9, 0x38, 0xf2, 0x11, 0x5f, 0xc8, 0x8b,
    0x03, 0xc5, 0x8f, 0x19, 0x54, 0x58, 0x23, 0x47,
    0xdd, 0xd9, 0x97,
#else
    0x44, 0x02, 0x5d, 0x1f, 0x00, 0x00, 0x39, 0x74,
    0x39, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x68, 0x6f,
...
t_oscore_c_5(void) {
  ...
  static const uint8_t protected[] = {
    ...
    0x39, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x68, 0x6f,
    0x73, 0x74, 0x63, 0x09, 0x14, 0x00, 0xff, 0x39,
    0x18, 0x2a, 0x77, 0x3d, 0xe9, 0x08, 0xdd, 0x09,
    0x7a, 0x0f, 0x6b, 0xbc, 0x4b, 0xd8, 0x5d, 0xfd,
    0x4d, 0xf7, 0xe8, 0xad,
  };
#else
  static const uint8_t protected[] = {
...
t_oscore_c_7(void) {
  ...
  static const uint8_t protected_coap_response[] = {
    ...
    0x90, 0xff, 0x40, 0x63, 0xd5, 0x2a, 0x2f, 0x62,
    0x86, 0xfb, 0x02, 0x1a, 0x23, 0x03, 0x6c, 0x89,
    0xce, 0x89, 0xa6, 0x68, 0x48, 0x65, 0x24, 0x11,
    0x26, 0xd8, 0x2f, 0xe0, 0xe6, 0x4c, 0xa2, 0x04,
#else
    0x64, 0x44, 0x5d, 0x1f, 0x00, 0x00, 0x39, 0x74,
...
#ifdef COAP_WITH_LIBTONGSUOMINI
    0x64, 0x44, 0x5d, 0x1f, 0x00, 0x00, 0x39, 0x74,
    0x92, 0x01, 0x00, 0xff, 0xf0, 0x3a, 0x7c, 0x4c,
    0x56, 0xd7, 0x2f, 0x84, 0x25, 0xbf, 0x5e, 0x88,
    0xd2, 0x7b, 0x0c, 0x68, 0xa3, 0x37, 0x0e, 0x62,
    0xc3, 0xc4, 0x63, 0x71, 0x37, 0x69, 0x4b, 0x99,
    0xb6, 0x02,
#else
    0x64, 0x44, 0x5d, 0x1f, 0x00, 0x00, 0x39, 0x74,
